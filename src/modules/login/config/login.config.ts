...
import { LoginAdminConfig } from './login-config.type';
...
export default registerAs<LoginAdminConfig>('auth', () => {
  console.info(`Register LoginAdminConfig from environment variables`);
